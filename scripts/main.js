// constants -----------------------------------------------------------------
const V1 = ['arise', 'awake', 'be', 'bear', 'beat', 'become', 'begin', 'bend', 'bind', 'bite', 'bleed', 'bless', 'blow', 'break', 'breed', 'bring', 'broadcast', 'build', 'burn', 'burst', 'buy', 'cast', 'catch', 'choose', 'cling', 'come', 'cost', 'creep', 'crow', 'cut', 'deal', 'dig', 'do', 'draw', 'dream', 'drink', 'drive', 'dwell', 'eat', 'fall', 'feed', 'feel', 'fight', 'find', 'flee', 'fling', 'fly', 'forbid', 'forecast', 'forget', 'freeze', 'get', 'give', 'go', 'grind', 'grow', 'hang', 'have', 'hear', 'heave', 'hew', 'hide', 'hit', 'hold', 'hurt', 'keep', 'kneel', 'knit', 'know', 'lay', 'lead', 'lean', 'leap', 'learn', 'leave', 'lend', 'let', 'lie', 'light', 'lose', 'make', 'mean', 'meet', 'mow', 'pay', 'prove', 'put', 'quit', 'read', 'rid', 'ride', 'ring', 'rise', 'run', 'saw', 'say', 'see', 'seek', 'sell', 'send'];
const V2 = ['arose', 'awoke, awaked', 'was, were', 'bore', 'beat', 'became', 'began', 'bent', 'bound', 'bit', 'bled', 'blessed', 'blew', 'broke', 'bred', 'brought', 'broadcast', 'built', 'burnt, burned', 'burst', 'bought', 'cast', 'caught', 'chose', 'clung', 'came', 'cost', 'crept', 'crew, crowed', 'cut', 'dealt', 'dug', 'did', 'drew', 'dreamt, dreamed', 'drank', 'drove', 'dwelt, dwelled', 'ate', 'fell', 'fed', 'felt', 'fought', 'found', 'fled', 'flung', 'flew', 'forbad, forbade', 'forecast, forecasted', 'forgot', 'froze', 'got', 'gave', 'went', 'ground', 'grew', 'hung', 'had', 'heard', 'heaved, hove', 'hewed', 'hid', 'hit', 'held', 'hurt', 'kept', 'knelt, kneeled', 'knitted, knit', 'knew', 'laid', 'led', 'leant, leaned', 'leapt, leaped', 'learnt, learned', 'left', 'lent', 'let', 'lay', 'lit, lighted', 'lost', 'made', 'meant', 'met', 'mowed', 'paid', 'proved', 'put', 'quit, quitted', 'read', 'rid', 'rode', 'rang', 'rose', 'ran', 'sawed', 'said', 'saw', 'sought', 'sold', 'sent'];
const V3 = ['arisen', 'awoken, awaked', 'been', 'borne', 'beaten, beat', 'become', 'begun', 'bent', 'bound', 'bitten', 'bled', 'blessed, blest', 'blown', 'broken', 'bred', 'brought', 'broadcast', 'built', 'burnt, burned', 'burst', 'bought', 'cast', 'caught', 'chosen', 'clung', 'come', 'cost', 'crept', 'crowed', 'cut', 'dealt', 'dug', 'done', 'drawn', 'dreamt, dreamed', 'drunk', 'driven', 'dwelt, dwelled', 'eaten', 'fallen', 'fed', 'felt', 'fought', 'found', 'fled', 'flung', 'flown', 'forbidden', 'forecast, forecasted', 'forgotten', 'frozen', 'got, gotten', 'given', 'gone', 'ground', 'grown', 'hung', 'had', 'heard', 'heaved, hove', 'hewn', 'hidden', 'hit', 'held', 'hurt', 'kept', 'knelt, kneeled', 'knitted, knit', 'known', 'laid', 'led', 'leant, leaned', 'leapt, leaped', 'learnt, learned', 'left', 'lent', 'let', 'lain', 'lit, lighted', 'lost', 'made', 'meant', 'met', 'mown, mowed', 'paid', 'proven, proved', 'put', 'quit, quitted', 'read', 'rid', 'ridden', 'rung', 'risen', 'run', 'sawn', 'said', 'seen', 'sought', 'sold', 'sent'];
const MEANING = ['Phát sinh', 'Đánh thức, thức', 'Thì, là, ở', 'Mang, chịu đựng', 'Đánh, đánh bại', 'Trở nên', 'Bắt đầu', 'Bẻ cong, cuối xuống', 'Buộc, trói', 'Cắn, ngoạm', 'Chảy máu', 'Ban phước lành', 'Thổi', 'Vỡ, đạp vỡ', 'Nuôi, dạy dỗ', 'Mang đến', 'Phát thanh', 'Xây dựng', 'Đốt, cháy', 'Nổ tung', 'Mua', 'Ném, tung', 'Bắt, chụp', 'Chọn, lựa', 'Bám chặt', 'Đến', 'Trị giá', 'Bò', 'Gáy', 'Cắt', 'Giao thiệp', 'Đào', 'Làm', 'Vẽ', 'Mơ', 'Uống', 'Lái xe', 'Ngụ, ở', 'Ăn', 'Rơi, ngã', 'Cho ăn, nuôi', 'Cảm thấy', 'Chiến đấu', 'Thấy', 'Chạy trốn', 'Tung, quăng', 'Bay', 'Cấm', 'Dự đoán', 'Quên', 'Đóng băng', 'Có được', 'Đưa', 'Đi', 'Nghiền, xay', 'Mọc, trồng', 'Treo lên', 'Có, sở hữu', 'Nghe', 'Trục lên', 'Chặt, đốn', 'Trốn', 'Đụng', 'Cầm, nắm', 'Làm đau', 'Giữ', 'Quỳ', 'Đan', 'Biết', 'Đặt, để', 'Dẫn dắt, lãnh đạo', 'Dựa, nghiêng', 'Nhảy, nhảy qua', 'Học', 'Ra đi, để lại', 'Cho mượn', 'Để', 'Nằm', 'Thắp sáng', 'Mất', 'Chế tạo, sản xuất', 'Nghĩa là', 'Gặp', 'Cắt cỏ', 'Trả (tiền)', 'Chứng tỏ', 'Đặt, để', 'Bỏ', 'Đọc', 'Giải thoát', 'Cưỡi (xe dạp, ngựa..)', 'Reo', 'Tăng, mọc lên', 'Chạy', 'Cưa', 'Nói', 'Nhìn, thấy', 'Tìm kiếm', 'Bán', 'Gửi']
const TEST_SIZE = 10;
